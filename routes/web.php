...
Route::get('/fix-database-schema', function () {
    ...
    $queries = [
        ...
        "ALTER TABLE `trx_batchjob_register` ADD `tipe_pelanggan` VARCHAR(50) NULL DEFAULT NULL AFTER `note_request`",
        "ALTER TABLE `m_pelanggan` ADD `tipe_pelanggan` VARCHAR(50) NULL DEFAULT NULL",
        ...
        "ALTER TABLE `m_olt` ADD `telnet_port` INT NULL DEFAULT 23",
        "ALTER TABLE `m_olt` ADD `telnet_username` VARCHAR(100) NULL DEFAULT 'admin'",
        "ALTER TABLE `m_olt` ADD `telnet_password` TEXT NULL DEFAULT NULL",
        "ALTER TABLE `m_olt` ADD `telnet_timeout` INT NULL DEFAULT 10",
