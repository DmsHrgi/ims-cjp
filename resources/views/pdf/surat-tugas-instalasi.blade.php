...
<body>
    ...
    <div class="content-p">
        Dengan surat ini pada tanggal, <strong>{{ $instalasiDateFormatted }}</strong> PT Media Solusi Network menugaskan tim teknisi, <strong>{{ strtoupper($instalasiTeam) }}</strong>. Untuk melakukan pemasangan jaringan internet ke pada pelanggan baru dengan rincian sebagai berikut :
    </div>
