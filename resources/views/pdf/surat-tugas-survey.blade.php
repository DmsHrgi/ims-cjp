...
<body>
    ...
    <div class="content-container">
        ...
        <div class="content-p">
            Dengan surat ini pada tanggal, <strong>{{ $surveyDateFormatted }}</strong> PT Connecti Jelajah Priangan menugaskan tim teknisi, <strong>{{ strtoupper($surveyTeam) }}</strong>. Untuk melakukan survei lokasi pemasangan jaringan internet ke pada pelanggan baru dengan rincian sebagai berikut :
        </div>
